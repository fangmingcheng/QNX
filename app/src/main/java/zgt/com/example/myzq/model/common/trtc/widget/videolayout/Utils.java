package zgt.com.example.myzq.model.common.trtc.widget.videolayout;
...
//            layoutParams.leftMargin = layoutWidth - lrMargin - subWidth;
            layoutParams.topMargin = bottomMargin + midMargin * (i + 1) + subHeight * i;
            layoutParams.leftMargin = lrMargin;
//            layoutParams.topMargin = subHeight;
