...
//    Button Bt_open;
    ...
    private void setData(){
        Tv_price.setText(Html.fromHtml("价格：<font color='#FFFFFF' size='20dp'>"+list.get(4).getPrice()+"</font>元/年"));
        Tv_content.setText(list.get(4).getIntro());
        if("VIP版".equals(SPUtil.getTypename())){
//            Tv_price.setText(Html.fromHtml("价格：<font color='#FFFFFF' size='20dp'>"+list.get(0).getPrice()+"</font>元/年"));
            Tv_status.setText("已开通");
            Tv_time.setText(myMember.getStartdate()+" - "+myMember.getEnddate());
