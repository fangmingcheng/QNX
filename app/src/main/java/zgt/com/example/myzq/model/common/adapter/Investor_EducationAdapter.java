...
public class Investor_EducationAdapter extends RecyclerView.Adapter<Investor_EducationAdapter.ViewHolder> {
    private List<Training> list=new ArrayList<>();
    private Context context;

    public Investor_EducationAdapter(Context context, List<Training> trainings){
