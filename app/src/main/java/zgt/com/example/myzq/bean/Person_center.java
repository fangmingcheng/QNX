...
//    private String enddate;//服务结束时间
    private int orderNum;//我的购买记录数量
    private int getuistatus;//0不推送，1全部推送，2系统消息推送，不推送普通消息，3普通消息推送，系统消息不推送
    ...
    public void setGetuistatus(int getuistatus) {
