...
//    Button Bt_open;
    ...
    private void setData(){
        Tv_price.setText(Html.fromHtml("价格：<font color='#FFFFFF' size='20dp'>"+list.get(1).getPrice()+"</font>元/年"));
        Tv_content.setText(list.get(1).getIntro());
        if("博弈版".equals(SPUtil.getTypename())){
