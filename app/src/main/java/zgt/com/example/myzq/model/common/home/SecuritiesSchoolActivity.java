...
import zgt.com.example.myzq.model.common.home.fragment.CoursewareFragment;
import zgt.com.example.myzq.model.common.home.fragment.VideosFragment;
import zgt.com.example.myzq.utils.Log;

/**
 * 证券学堂
 */
public class SecuritiesSchoolActivity extends BaseActivity implements ViewPager.OnPageChangeListener{
    ...
    public void initViews(Bundle savedInstanceState) {
        ...
        list.add(new CoursewareFragment());
    ...
    public int getLayoutId() {
        return R.layout.activity_securities_school;
    }
