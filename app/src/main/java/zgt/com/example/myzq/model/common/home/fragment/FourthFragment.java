...
//    Button Bt_open;
    ...
    private void setData(){
        Tv_price.setText(Html.fromHtml("价格：<font color='#FFFFFF' size='20dp'>"+list.get(3).getPrice()+"</font>元/年"));
        Tv_content.setText(list.get(3).getIntro());
        if("钻石版".equals(SPUtil.getTypename())){
