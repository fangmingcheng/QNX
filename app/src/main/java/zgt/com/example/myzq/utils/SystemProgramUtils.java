...
public class SystemProgramUtils {
    ...
    public static void paizhao(Activity activity, File outputFile, int status){
    ...
    public static void zhaopian(Activity activity,int status){
        Intent intent = new Intent();
    ...
    public static void Caiqie(Activity activity, Uri uri, File outputFile,int status) {
