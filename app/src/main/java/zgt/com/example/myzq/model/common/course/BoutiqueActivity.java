...
//        recyclerview.setLayoutManager(new StaggeredGridLayoutManager(4,StaggeredGridLayoutManager.VERTICAL));
        ...
        adapter.setOnItemClickListener(new CourseAdapter.OnItemClickListener() {
            ...
            public void OnItemClick(View view) {
                ...
                startActivity(new Intent().setClass(BoutiqueActivity.this, CourseDetailActivity.class).putExtra("uuid",list.get(position).getUuid()).putExtra("index",1));
            }
        });
        ...
        refreshLayout.setOnLoadMoreListener(new OnLoadMoreListener() {
            ...
            public void onLoadMore(@NonNull RefreshLayout refreshLayout) {
                if(totalcount>(currentpage-1)*20){
                    ...
                    ToastUtil.showShortToast(BoutiqueActivity.this,"数据已加载完毕");
...
//                cursorAnim(1);
    ...
    private void getData(final RefreshLayout refreshLayout,final int num){
        ...
        requestParams.addParameter("isboutique", 1);
...
//                                            }).create().show();
//                                }
                                startActivity(new Intent().setClass(BoutiqueActivity.this, LoginActivity.class));
                                finish();
                            }
                        });
                        ...
                        runOnUiThread(new Runnable() {
                            @Override
                            public void run() {
                                ToastUtil.showShortToast(BoutiqueActivity.this, msg);
                            }
                        });
                    }
...
//                            ToastUtil.showShortToast(getActivity(), getString(R.string.login_parse_exc));
            ...
            public void onError(Throwable ex, boolean isOnCallback) {
                ...
                runOnUiThread(new Runnable() {
                    @Override
                    public void run() {
                        ToastUtil.showShortToast(BoutiqueActivity.this, "网络连接异常");
                    }
                });
            }
