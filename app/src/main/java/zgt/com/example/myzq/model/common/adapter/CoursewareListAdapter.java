...
public class CoursewareListAdapter extends RecyclerView.Adapter<CoursewareListAdapter.ViewHolder> {
    private List<Courseware> list=new ArrayList<>();
    private Context context;

    public CoursewareListAdapter(Context context, List<Courseware> coursewares){
        this.context=context;
        this.list=coursewares;
    }
    ...
    public void onBindViewHolder(final ViewHolder holder, int position) {
        Courseware live=list.get(position);
        ...
        holder.Tv_Member.setText("共"+live.getTotalnum()+"节");
    }
