...
public class AdviserAdapter extends  RecyclerView.Adapter<AdviserAdapter.ViewHolder> {
    ...
    public AdviserAdapter(Context context, List<Member> live_listingses){
    ...
    public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view= LayoutInflater.from(parent.getContext()).inflate(R.layout.adapter_adviser,parent,false);
