package zgt.com.example.myzq.model.common.trtc;
...
import zgt.com.example.myzq.model.common.trtc.customCapture.TestRenderVideoFrame;
import zgt.com.example.myzq.model.common.trtc.customCapture.TestSendCustomVideoData;
import zgt.com.example.myzq.model.common.trtc.utils.Utils;
import zgt.com.example.myzq.model.common.trtc.widget.TRTCBeautySettingPanel;
import zgt.com.example.myzq.model.common.trtc.widget.TRTCMoreDialog;
import zgt.com.example.myzq.model.common.trtc.widget.TRTCSettingDialog;
import zgt.com.example.myzq.model.common.trtc.widget.videolayout.TRTCVideoLayoutManager;


public class TRTCMainActivity extends Activity implements View.OnClickListener, TRTCBeautySettingPanel.IOnBeautyParamsChangeListener, TRTCMoreDialog.IMoreListener, TRTCSettingDialog.ISettingListener, TRTCVideoLayoutManager.IVideoLayoutListener {
...
//    private LinearLayout mLlAnchorPanel;             // 主播功能面板
    ...
    private ImageView trtc_iv_switch_role;
...
//    private ImageView                           mIvEnableVideo, mIvEnableAudio;
    ...
    private boolean isVirtical = true;//判断横竖屏

    private static  boolean isShow = false;//判断是否共享屏幕
    /**
     * 混流配置相关
     */
...
//        findViewById(R.id.trtc_iv_beauty).setOnClickListener(this);
        trtc_iv_switch_role = (ImageView) findViewById(R.id.trtc_iv_switch_role);
        trtc_iv_switch_role.setOnClickListener(this);
...
//
//            bundle.putInt("code",errCode);
//            bundle.putString("errMsg",errMsg);
//            Message msg= VideoFlutterPlugin.mhandler.obtainMessage();
//            msg.what=1;
//            msg.setData(bundle);
//            msg.sendToTarget();
            activity.finish();
...
//                bundle.putString("errMsg","客服终止了视频服务");
//                Message msg= VideoFlutterPlugin.mhandler.obtainMessage();
//                msg.what=1;
//                msg.setData(bundle);
//                msg.sendToTarget();
         ...
         * Demo 在收到主播有上行流的时候，会通过{@link TRTCCloud#startRemoteView} 开始渲染
         * Demo 在收到主播停止上行的时候，会通过{@link TRTCCloud#stopRemoteView} 停止渲染，并且更新相关 UI
         *
         * @param userId    用户标识
...
////                        activity.startSDKRender(userId, isShow, TRTCCloudDef.TRTC_VIDEO_STREAM_TYPE_SUB);
//                        activity.mTRTCVideoLayout.recyclerCloudViewView(userId, TRTCCloudDef.TRTC_VIDEO_STREAM_TYPE_SUB);
//                    }else {
//
//                    }
        ...
        /**
         * 是否有辅路上行的回调，Demo 中处理方式和主画面的一致 {@link TRTCCloudListenerImpl#onUserVideoAvailable}
         *
         * @param userId    用户标识
...
//        mIvEnableAudio.setImageResource(mIsEnableAudio ? R.mipmap.remote_audio_enable : R.mipmap.remote_audio_disable);
    ...
    public void onConfigurationChanged(Configuration config) {
        ...
        if (config.orientation == ActivityInfo.SCREEN_ORIENTATION_PORTRAIT) {
            // 切换成竖屏
//            trtc_iv_switch_role.setImageResource(R.mipmap.ic_hengping);
//            setContentView(R.layout.activity_main);
            // findViewById
            // 进行一些操作。。。
        } else {
//            trtc_iv_switch_role.setImageResource(R.mipmap.ic_shuping);
            // 切换成横屏
//            setContentView(R.layout.activity_main);
            // findViewById
            // 进行一些操作。。。
...
//        VideoFlutterPlugin.messageChannel.send();
        exitRoom();
